...
/*    SerialUSB.println("approx. altitude = " + (String(altittude,2)) + " m");  a tutaj jeszcze do stringa => , \"altitude\": " + (String(altittude,2)) + " w razie co*/
  ...
  JsonData = "{" + (String(force,2)) + ",\ " + (String(temperature,2)) + ",\ " + (String(pressure,2)) + ",\ " + (String(acceleration_x,2)) + ",\ " + (String(acceleration_y,2)) + ",\ " + (String(acceleration_z,2)) +",\ " + (String(time,2)) + ",\ " + (String(rotation_x,2)) + ",\ " + (String(rotation_y,2)) + ",\ " + (String(rotation_z,2)) + ",\ " + (String(lat,6)) + ",\ " + (String(lng,6)) + ",\ " + (String(alt,2)) + "}";
